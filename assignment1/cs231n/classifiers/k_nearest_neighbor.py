...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    dists = np.sqrt(test_square - 2 * test_dot_train + train_square)
    #########################################################################
    #                         END OF YOUR CODE                              #
    #########################################################################
    return dists
...
#2nd implement       y_pred[i] = max(set(closest_y),key=list(closest_y).count)
#3rd implement       y_pred[i] = max(set(closest_y), key=lambda p:np.count_nonzero(closest_y==p))
      #########################################################################
      #                           END OF YOUR CODE                            # 
      #########################################################################
